                    ...
                    <table class="table" id="dataTable">
                        ...
                        ?>
                              <tr>
                                ...
                                <td>
                                  <a href = 'delete.php?assetID=<?php echo $row["a_assetID"]; ?>' class = 'btn btn-danger' style="color:rgb(14,14,14)"   onclick="return confirm('Are you sure you want to delete this assets?')"><strong>X</strong></a>
                                </td>
          ...
          <div class="card shadow">
            <div class="card-body">
              <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                  ...
                  <form action="mainC.php" method="GET"> 
