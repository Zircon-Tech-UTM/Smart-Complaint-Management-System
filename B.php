    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="opacity: 1;filter: brightness(94%) contrast(114%);background: #0902d6;color: rgb(255,255,255);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="B.php">
                    ...
                    <div class="sidebar-brand-text mx-6"><span><bold><?php echo $language['Management']; ?></bold></span></div>
                </a>
            ...
            <div id="content" style="margin: 2px;">
                ...
                <div class="row">
                        <div class="col-md-6 col-xl-4 mb-4">
                            ...
                            <a class="card-block stretched-link text-decoration-none" href="complaintsB/readComplaint.php">
                        ...
                        <div class="col-md-6 col-xl-4 mb-4">
                            <div class="card text-white bg-white text-justify shadow border-left-warning py-2" style="height: 169px;">
                                <a class="card-block stretched-link text-decoration-none" href="assets/mainB.php">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-warning font-weight-bold text-xs mb-1"></div>
