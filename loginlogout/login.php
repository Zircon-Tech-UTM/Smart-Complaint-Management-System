            ...
            <img src="../img/kvpjb.jpg">
                  ...
                  <form>
                    ...
                    <label for="pwd"><b>Password:</b></label>
                        ...
                        <input type="Password" class="form-control" placeholder="Password" name="pwd" value="<?php if(isset($_COOKIE["member_pwd"])) {echo $_COOKIE["member_pwd"];}?>" required/>
                    </div>
                    <div class="img-container"> <!-- Block parent element -->
                    <p><input type="checkbox" checked="checked" name="remember" id="remember"<?php if(isset($_COOKIE["member_ic"])) { ?> checked <?php }?>/>
