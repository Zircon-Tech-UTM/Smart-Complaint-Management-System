<?php 
    ...
    if (isset($_POST["name"])){
        $sql .= " AND (name LIKE '%".$_POST["name"]."%' or postBI LIKE '%".$_POST["name"]."%' or postBM LIKE '%".$_POST["name"]."%' or a_nameBI LIKE '%".$_POST["name"]."%' or a_nameBM LIKE '%".$_POST["name"]."%' or cat_nameBM LIKE '%".$_POST["name"]."%' or cat_nameBI LIKE '%".$_POST["name"]."%' or r_nameBM LIKE '%".$_POST["name"]."%' or r_nameBI LIKE '%".$_POST["name"]."%' or s_nameBI LIKE '%".$_POST["name"]."%' or s_nameBM LIKE '%".$_POST["name"]."%')";
    }else{
        $_POST["name"] = "";
    }
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            ...
                            <form action="acceptedComplaints.php" method="POST">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="<?php echo $language['search by proposer or follower name'];?>" aria-label="search..." aria-describedby="button-addon2" name = "name" value="<?php echo $_POST["name"]; ?>">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            ...
                            <form action="acceptedComplaints.php" method="POST">
                                        ...
                                        <select class="form-select" aria-label="Default select example" id="rooms" name="rooms">
                                            <option value="" selected><?php echo $language['Open this select menu'];?></option>
                                            <?php
                                                $sql4 = "SELECT * FROM rooms WHERE blok = '".$_POST['blocks']."';";
                                                $result4 = mysqli_query($conn, $sql4);
                                                if(isset($_POST["rooms"])){
                                                    while ($row4 = mysqli_fetch_array($result4)){
                                                        if ($row4['r_roomID'] == $_POST['rooms']){
                                                            if ($_SESSION['language'] == 'BI'){
