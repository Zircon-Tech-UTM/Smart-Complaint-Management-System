                                ...
                                <a class="card-block stretched-link text-decoration-none" href="dashboard.php">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <img src="assets/img/dashboard-1739866-1481441.png" style="width: 113px;height: 104px;padding: -52px;margin: 5px;"><span class="text-center text-dark" style="width: -4px;font-size: 20px;font-family: Nunito, sans-serif;text-align: center;color: rgb(0,0,0);"><strong><?php echo $language['MY DASHBOARD']; ?></strong><br></span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                    ...
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center"> &nbsp;
                                             <img src="assets/img/2048413-200.png" style="width: 100px;height: 104px;padding: -52px;margin: 5px;"><span class="text-center text-dark" style="width: -4px;font-size: 20px;font-family: Nunito, sans-serif;text-align: center;color: rgb(0,0,0);"><strong><?php echo $language['Complaint Management']; ?></strong></span>   
                                            </div>
                                        </div>
                                    </div>
                                </a>
