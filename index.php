                                ...
                                <a class="card-block stretched-link text-decoration-none" href="#">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <img src="assets/img/dashboard-1739866-1481441.png" style="width: 113px;height: 104px;padding: -52px;margin: 5px;"><span class="text-center text-dark" style="width: -4px;font-size: 20px;font-family: Nunito, sans-serif;text-align: center;color: rgb(0,0,0);"><strong>MY DASHBOARD</strong><br></span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                    ...
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                             <img src="assets/img/2048413-200.png" style="width: 125px;height: 110px;padding: -52px;margin: 5px;"><span class="text-center text-dark" style="width: -4px;font-size: 20px;font-family: Nunito, sans-serif;text-align: center;color: rgb(0,0,0);"><strong>COMPLAINTS<br>MANAGEMENT</strong></span>   
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a class="card-block stretched-link text-decoration-none" href="users/readUser.php">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <img src="assets/img/img_382262.png"  style="width: 113px;height: 104px;padding: -52px;margin: 5px;"><span class="text-center text-dark" style="width: -4px;font-size: 20px;font-family: Nunito, sans-serif;text-align: center;color: rgb(0,0,0);"><strong>USER MANAGEMENT</strong></span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="card text-white bg-white text-justify shadow border-left-warning py-2" style="height: 169px;">
                                <a class="card-block stretched-link text-decoration-none" href="assets/main.php">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-warning font-weight-bold text-xs mb-1"></div>
                                            <img src="assets/img/223712-200.png"  style="width: 113px;height: 104px;padding: -52px;margin: 5px;"><span class="text-center text-dark" style="width: -4px;font-size: 20px;font-family: Nunito, sans-serif;text-align: center;color: rgb(0,0,0);"><strong>ASSET MANAGEMENT</strong><br></span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a class="card-block stretched-link text-decoration-none" href="Rooms/roomlist.php">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-warning font-weight-bold text-xs mb-1"></div>
                                            <div class="row no-gutters align-items-center">
                                                <img src="assets/img/room%20(1).png"  style="width: 113px;height: 104px;padding: -52px;margin: 5px;"><span class="text-center text-dark" style="width: -4px;font-size: 20px;font-family: Nunito, sans-serif;text-align: center;color: rgb(0,0,0);"><strong>ROOM MANAGEMENT</strong></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                 ...
                                 <a class="card-block stretched-link text-decoration-none" href="Blocks/blocklist.php">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-warning font-weight-bold text-xs mb-1"></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"></div>
                                            <img src="assets/img/1710329-200.png" style="width: 113px;height: 104px;padding: -52px;margin: 5px;"><span class="text-center text-dark" style="width: -4px;font-size: 20px;font-family: Nunito, sans-serif;text-align: center;color: rgb(0,0,0);"><strong>BLOCK MANAGEMENT</strong></span>
                                        </div>
                                    </div>
                                </a>
                            </div>
