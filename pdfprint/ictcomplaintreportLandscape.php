...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="printLandscape.css" media="print" > 
...
<body onafterprint="myFunction()">
  ...
  <?php 
    $results = mysqli_query($conn, "SELECT c.proposedDate , c.c_assetID, c.detail ,u.name ,  c.setledDate
    FROM complaints c 
    JOIN users u
