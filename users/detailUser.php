...
<body>
    <div class="container">
        <div class="container-fluid float-left">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody style="color: rgb(0,0,0);">
                                        ...
                                        <?php if ($row['postBI']=="PIC Of Room"||$row['postBM']=="PIC Makmal") { ?>
                                            <tr>
                    ...
                    <a href="deleteUser.php?id=<?php echo $row["u_userIC"];?>" class="btn btn-danger" onclick="return confirm('<?php echo $language['Are you sure to delete this complaint?']; ?>')" ><?php echo $language['Delete']; ?></a>
