<?php
    ...
    $sql = "SELECT * FROM users WHERE u_userIC='".$uid."';";
...
<body>
    <form action="updateUser.php?id=<?php echo $uid; ?>" enctype="multipart/form-data" method="POST">
        ...
        <div class="container">
            ...
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <img id="blah" src="<?php echo $row["u_img_path"];?>" alt="your image" />
                ...
                <input type="submit" text-align:center name="submit" class="btn btn-primary" onclick="return confirm('Are you sure you want to delete this account?')" value="Submit"/>
