    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") 
    {
            ...
            &&empty($confirm_passwordErr)&&empty($gradesErr)&&empty($positionBIErr)&&empty($addrErr))
        {
                ...
                if ($imgExt== "")
                    ...
                    $sql = "UPDATE users
                        SET  u_userIC='".$IC."' ,pwd='".$password."', name='".$username."', postBI='".$positionBI."',postBM='".$positionBM."', address='".$addr."', email='".$email."', contact= '".$contact."',  userType='".$userType."',  u_grade='".$grades."', u_img_path = '".$path."' 
                        WHERE u_userIC='".$IC."';";
                }
