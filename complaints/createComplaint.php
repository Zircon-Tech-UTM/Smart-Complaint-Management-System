                ...
                <div class="card shadow mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="detail" id="complainantDetail" class="form-control form-control-lg <?php echo (!empty($detailErr)) ? 'is-invalid' : ''; ?>" placeholder="<?php echo $language["Complainant's detail"]; ?>" value="<?php echo $detail; ?>">
