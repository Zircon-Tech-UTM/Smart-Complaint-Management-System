...
<head>
  <title><?php echo $language['Login Page']; ?></title>
...
<body>
  ...
  <form action="loginprocess.php" method="post" id="frmLogin">
    ...
    <div class="container main-section">
          <h1 style="text-align:center"><?php echo $language['Login Form']; ?></h1>
    </div>
            ...
            <img src="../img/kvpjb.png">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 user-login-box">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="<?php echo $language['Enter IC']; ?>" id="fid" name="ic" value="<?php if(isset($_COOKIE["member_ic"])) {echo $_COOKIE["member_ic"];}?>" required/>
                  </div>
                  <script>
                    function myFunction() 
                {
                  ...
                  <div class="form-group">
                    <div class="img-container"> <!-- Block parent element -->
                      <label for="pwd"><b><?php echo $language['Password:']; ?></b></label>
                    </div>

                    <input type="Password" class="form-control" placeholder="<?php echo $language['Enter Password']; ?>" name="pwd" id="pwd" value="<?php if(isset($_COOKIE["member_pwd"])) {echo $_COOKIE["member_pwd"];}?>" required/><br>
                    <div class="img-container"> <!-- Block parent element -->
                    ...
                    <label for="remember-me"><?php echo $language['Remember me']; ?></label>
                  <br><br>
          
                  <button type="submit" name="login" value="Login"class="button"><?php echo $language['Login']; ?></a>
              </div>

            <div class="col-md-12 col-sm-12 col-xs-12 last-part">
              <p><a href="forgotpwd.php"><?php echo $language['Forget Password?']; ?></a></p>
            </div>
